<section class="hdl-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  Quốc Tài Shop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
                  mong muốn đem đến chất lượng tốt nhất cho khách hàng.
               </p>
               <p class="pt-1">
                  Địa chỉ: Số 368, đường 30 tháng 4, phường Chánh Nghĩa, Thành phố Thủ Dầu Một, tỉnh Bình Dương
               </p>
               <p class="pt-1">
                  Điện thoại: 0792187620(call, zalo) - Email: quoctai@gmail.com
               </p>
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Phạm Quốc Tài - Phone: 0792187620
      </div>
   </section>
</body>
